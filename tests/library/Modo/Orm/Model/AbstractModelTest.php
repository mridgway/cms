 ...
 */
class AbstractModelTest extends \PHPUnit_Framework_TestCase implements \Doctrine\Common\PropertyChangedListener {
    /**
     * @var Entity
     */
    protected $model;

    protected $propertyChanged = false;
    ...
    protected function setUp() {
        $this->model = new \Mock\Modo\Orm\Model\ModelMock;
    }
    ...
    public function testAddPropertyChangedListener() {
        ...
        $this->model->num = 2;
        $this->assertTrue($this->propertyChanged);
    }
