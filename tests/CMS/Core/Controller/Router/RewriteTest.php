...
class RewriteTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $request = new \Core\Controller\Request\Http('http://cms/sadfasdfasdf');
        $this->rewrite->route($request);
    }

    public function testTestRoute()
    {
        $request = new \Core\Controller\Request\Http('http://cms/test');
        $this->rewrite->route($request);
    ...
    {
        $request = new \Core\Controller\Request\Http('http://cms/blog/article/1');
        $this->rewrite->route($request);
        $route = $this->rewrite->getCurrentRoute();
    ...
    {
        $request = new \Core\Controller\Request\Http('http://cms/direct/controller/action');
        $this->rewrite->route($request);
        $route = $this->rewrite->getCurrentRoute();
    ...
    {
        $request = new \Core\Controller\Request\Http('http://cms/direct/module/controller/action');
        $this->rewrite->route($request);
        $route = $this->rewrite->getCurrentRoute();
