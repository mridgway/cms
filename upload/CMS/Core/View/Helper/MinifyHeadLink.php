 ...
 *
 */
class Core_View_Helper_MinifyHeadLink extends Zend_View_Helper_HeadLink {
	/**
	 *
     ...
     * @var string
     */
    protected $_regKey = 'Zend_View_Helper_MinifyHeadLink';
	...
	public function toString($indent = null) {
        if (!\Zend_Registry::get('config')->cssCache->enabled) {
