 ...
 * @version    $Id: FormLabelWithTooltip.php 749 2010-07-29 14:23:58Z mike $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Core_View_Helper_FormLabelWithTooltip extends \Zend_View_Helper_FormElement
{
    /**
     ...
     */
    public function formLabelWithTooltip($name, $value = null, array $attribs = array())
    {
        ...
        $tooltip = $attribs['tooltip'];
        unset($attribs['tooltip']);

        // enabled; display label
        $xhtml = '<label'
                . $for
                . $this->_htmlAttribs($attribs)
                . '>' . $value . ' <a href="#" class="tooltip">[?]<span>'
